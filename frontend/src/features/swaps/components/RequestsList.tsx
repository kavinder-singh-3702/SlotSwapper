...
import type { PopulatedSwapRequest } from '@/features/events/types';
    ...
    <li className="list-item">
      <div style={{ display: 'grid', gap: '0.5rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <strong>
            {variant === 'incoming'
              ? `${request.requester.name} wants ${request.responderSlot.title}`
              : `Waiting on ${request.responder.name}`}
          </strong>
        ...
        <div className="grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))' }}>
          <div
            className="card"
            style={{ background: 'rgba(15, 23, 42, 0.65)', border: '1px solid rgba(148,163,184,0.12)' }}
          >
